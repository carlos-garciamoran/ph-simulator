...
export function get_ace_buffer_system(NaC2H3O2_conc: number, HC2H3O2_conc: number)  {
    ...
    return constants.pKa_acetic_acid +  Math.log10(get_NaC2H3O2_Hplus(NaC2H3O2_conc) / get_HC2H3O2_Hplus(HC2H3O2_conc))
}
...
export function get_NaOH_HC2H3O2(HC2H3O2_conc: number, M_NaOH: number, drops: number)  {
    ...
    return ((10.000 * HC2H3O2_conc) - (constants.drop_volume * drops * M_NaOH)) / get_total_volume(drops)
}

export function get_NaOH_NaC2H3O2(NaC2H3O2_conc: number, M_NaOH: number, drops: number)  {

    return ((10.000 * NaC2H3O2_conc) + (constants.drop_volume * drops * M_NaOH)) / get_total_volume(drops)
}
...
export function get_acid_base_buffer_system(pKa_acid: number, acid_conc: number, base_conc: number, M_HCl: number, drops: number)  {
...
export function get_NaOH_acid(H_conc: number, M_NaOH: number, drops: number)  {
    ...
    return ((10.000 * H_conc) - (constants.drop_volume * drops * M_NaOH)) / get_total_volume(drops)
}

export function get_NaOH_base(Na_conc: number, M_NaOH: number, drops: number)  {

    return ((10.000 * Na_conc) + (constants.drop_volume * drops * M_NaOH)) / get_total_volume(drops)
}
